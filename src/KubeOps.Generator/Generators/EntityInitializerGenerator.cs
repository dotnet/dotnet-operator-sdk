...
internal sealed class EntityInitializerGenerator : IIncrementalGenerator
{
        ...
        string? generatorNamespace)
    {
        ...
        var staticInitializedEntities = entities
        ...
        if (staticInitializedEntities.Count == 0)
        {
            return;
        }
        ...
        var staticInitializers = CompilationUnit()
            ...
            .AddMembers(ClassDeclaration("EntityInitializer")
                .WithModifiers(TokenList(
                    Token(SyntaxKind.InternalKeyword), Token(SyntaxKind.StaticKeyword)))
                .WithMembers(List<MemberDeclarationSyntax>(staticInitializedEntities
