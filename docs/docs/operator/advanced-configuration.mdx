...
- The entity is then allowed to be deleted by Kubernetes
    ...
    where TEntity : IKubernetesObject<V1ObjectMeta>
{
    ...
    {
        // Azure Service Bus doesn't support removing scheduled messages
        // Consider using message deduplication or message properties to skip processing
