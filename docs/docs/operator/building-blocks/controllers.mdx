...
- N controllers means N watch connections per entity type by default. If that becomes a concern
  ...
  [`WatchStrategy` in Advanced Configuration](../advanced-configuration).
