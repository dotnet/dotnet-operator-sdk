...
4. **High Availability**:
   ...
   - Configure leader election for coordinated operation (see [Advanced Configuration - Leader Election](./configuration/leader-election#custom-leader-election))
   - Consider namespace-based distribution for horizontal scaling
