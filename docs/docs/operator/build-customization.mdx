...
<PropertyGroup>
    ...
    <!-- Namespace of the operator deployment (defaults to '<operator-name>-system') -->
    <KubeOpsNamespace>tenant-a</KubeOpsNamespace>

    <!-- RBAC scope: auto (default), cluster, or namespaced -->
    <KubeOpsRbacScope>namespaced</KubeOpsRbacScope>
</PropertyGroup>
```
