...
public class EntityInitializerGeneratorTest
{
    ...
    [Fact]
    public void Should_Generate_Default_Ctor_For_Partial_Entity_With_Metadata_Const()
    {
        var inputCompilation = """
                               ...
                               public partial class V1TestEntity : IKubernetesObject<V1ObjectMeta>
                               {
                                    ...
                                    public const string KubeGroup = "testing.dev";
                                    public const string KubeKind = "TestEntity";
                                    public const string KubePluralName = "testentities";
                               }
                               """.CreateCompilation();
        var expectedResult = """
                             // <auto-generated>
    ...
    [Fact]
    public void Should_Generate_Default_Ctor_For_Partial_Entity_With_External_Metadata_Const()
    {
        var inputCompilation = """
                               ...
                               [KubernetesEntity(Group = Constants.KubeGroup, ApiVersion = Constants.KubeApiVersion, Kind = Constants.KubeKind, PluralName = Constants.KubePluralName)]
                               public partial class V1TestEntity : IKubernetesObject<V1ObjectMeta>;
                               """.CreateCompilation();
        var expectedResult = """
                             // <auto-generated>
