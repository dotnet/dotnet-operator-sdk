...
public sealed partial class FinalizerRegistrationGeneratorTest
{
    ...
    [InlineData(
        ...
        """
                     ...
                     """,
        TestDisplayName = "Test finalizer with entity from referenced assembly with constant values")]
    [InlineData(
        """
                using KubeOps.Generator.Test.Entities;
                using KubeOps.Abstractions.Reconciliation.Finalizer;
    ...
    [InlineData(
        ...
        """
                     ...
                     """,
        TestDisplayName = "Test finalizer with inheritance and with entity from referenced assembly")]
    [InlineData(
        """
                using KubeOps.Generator.Test.Entities;
                using KubeOps.Abstractions.Reconciliation.Finalizer;
    ...
    [InlineData(
        ...
        """
                     ...
                     """,
        TestDisplayName = "Test multiple finalizers with entity from referenced assembly")]
